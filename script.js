...
const animateElements = document.querySelectorAll(
    '.about-content, .skill-category, .timeline-item, .project-card, .education-card, .award-card, .contact-content'
);
...
// Add active class styling via CSS (we'll add this dynamically)
...
console.log('%cBuilt with HTML, CSS, and Vanilla JavaScript', 'color: #6b7280; font-size: 12px;');
